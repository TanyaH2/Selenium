...
public class HomeWorkTestCase {
	/**
	 * TC1:Tools QA check all elements Open chrome browser Go to
	 ...
	 * “Selenium WebDriver” option as selected Quit browserelenium WebDriver” option
	 * as selected Quit browser
	 * 
